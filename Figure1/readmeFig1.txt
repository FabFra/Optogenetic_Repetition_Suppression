...
- "AverageFr" is the firing rate averaged across trials, computed for 900 ms;

In addition, the structure Exc contains:

- "FrPulse", the firing rate averaged across pulses and trials, computed for 30 ms (pulse onset at 10ms);
