...
- "FR" contains the firing rate of each cell of the corresponding population;
...
- "FRpulse", containing the firing rate of each cell of the corresponding population, aligned at pulse onset and averageed across pulses.
